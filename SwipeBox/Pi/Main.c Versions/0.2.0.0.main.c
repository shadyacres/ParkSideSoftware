...
*	Version: 0.2.0.0 (Major.Minor.Revision.Bug)
*	Date: 22/04/2015
**********************************************************/

// Includes for general program functionality
#include <stdio.h>
#include <time.h>
#include <stdlib.h>
#include <stdint.h>
...
// Include for extracting the NDEF record
#include <CheckNdef.h>

// Includes for card emulation
#include <phhalHw.h>
#include <phOsal.h>
#include <phCardEmu.h>
...
void SendToWebService(unsigned char *pID);
...
void *DetectCard()
{
	printf("DetectCard thread created\n");
...
void *DetectPhone()
{
	printf("DetectPhone thread created\n");
...
{
	pthread_t cardThread, phoneThread;
	
	printf("Creating threads. . .\n\n");
	pthread_create(&cardThread, NULL, &DetectCard, NULL);
	pthread_create(&phoneThread, NULL, &DetectPhone, NULL);
