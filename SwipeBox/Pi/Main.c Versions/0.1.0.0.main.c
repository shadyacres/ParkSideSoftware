...
const char * ReadCusID()
{
	printf("Read Cus ID function\n");
	const char* cusID = "1234567890";
	char* cusIDFromCard = malloc(strlen(cusID) + 1);

	return cusIDFromCard;
}
