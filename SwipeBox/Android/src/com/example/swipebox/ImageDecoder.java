...
public class ImageDecoder 
{
	...
	{
		Bitmap bitmap = BitmapFactory.decodeFile(fileName); // Decode file to bitmap.
		
		int scale = (int) (bitmap.getHeight() * (512.0 / bitmap.getWidth())); // Scale bitmap to compress.

		Bitmap scaledBitmap = Bitmap.createScaledBitmap(bitmap, 512, scale, true); // Scaled compressed bitmap.
